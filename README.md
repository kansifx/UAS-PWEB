...
```
C:\xampp\htdocs\UAS-PWEB\
+-- application/
|   +-- config/            # Konfigurasi CodeIgniter
|   +-- controllers/       # Controller (MVC)
|   |   +-- Admin.php      # Panel admin
|   |   +-- Auth.php       # Login / Register / Logout
|   |   +-- Certificate.php# Generate & download PDF sertifikat
|   |   +-- Chat.php       # Chat mentor (user side)
|   |   +-- Chatbot.php    # AI chatbot (Grok + Gemini)
|   |   +-- Codeeditor.php # Live code execution
|   |   +-- Courses.php    # My courses & completed courses
|   |   +-- Dashboard.php  # User dashboard
|   |   +-- Landingpage.php# Halaman depan
|   |   +-- Library.php    # Library kursus
|   |   +-- Mentor.php     # Panel mentor/instructor
|   |   +-- Modul.php      # Detail & belajar modul
|   |   +-- Payment.php    # Pembayaran premium
|   |   +-- Pricing.php    # Halaman pricing
|   |   +-- Profile.php    # Profil user
|   |   +-- Progress.php   # API progress tracking
|   |   +-- Settings.php   # Pengaturan akun
|   |   +-- Welcome.php    # Default CI controller
|   +-- models/
|   |   +-- Auth_model.php    # Model autentikasi
|   |   +-- Module_model.php  # Model modul kursus
|   +-- views/
|   |   +-- landingpage.php      # Halaman depan (hero, fitur, pricing, dll)
...
|   |   +-- premium_features.php # Fitur premium
|   |   +-- auth/
|   |   |   +-- login.php        # Halaman login & register
|   |   +-- modul/
|   |   |   +-- detail.php             # Detail modul
|   |   |   +-- belajar_template.php   # Template belajar
|   |   |   +-- belajar/               # Konten per bahasa (12 file)
|   |   +-- courses/
|   |   |   +-- my_courses.php         # Kursus saya
|   |   |   +-- completed_courses.php  # Kursus selesai
|   |   +-- chat/
|   |   |   +-- index.php          # Chat mentor (user)
|   |   +-- codeeditor/
|   |   |   +-- index.php          # Live code editor
|   |   +-- certificate/
|   |   |   +-- template.php       # Template PDF sertifikat
|   |   +-- admin/
|   |   |   +-- dashboard.php      # Dashboard admin
|   |   |   +-- mentors.php        # Daftar mentor
|   |   |   +-- edit_mentor.php    # Edit mentor
|   |   |   +-- members.php        # Daftar member
|   |   |   +-- member_detail.php  # Detail progress member
|   |   |   +-- transactions.php   # Daftar transaksi
|   |   +-- mentor/
|   |       +-- dashboard.php           # Dashboard mentor
|   |       +-- modules.php             # Kelola modul
|   |       +-- edit_module.php         # Edit modul + video + sertifikat
|   |       +-- premium_members.php     # Daftar premium member
|   |       +-- premium_member_detail.php # Detail progress premium
|   |       +-- chat.php                # Chat dengan member
|   |       +-- change_password.php     # Ganti password mentor
|   +-- ...
+-- assets/
|   +-- css/
|   |   +-- global-style.css    # CSS global (tokens, layout)
|   |   +-- style-modul.css     # CSS spesifik modul
|   +-- ...
+-- system/                  # CodeIgniter 3 system files
+-- vendor/                  # Composer dependencies (Dompdf, dll)
