...
<body>
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <div class="sidebar-footer">
      ...
      <?php endif; ?>
      <a href="<?= site_url('auth/logout') ?>" class="side-link" style="margin-top:0.6rem;color:var(--charcoal);">
    ...
    <div class="content-wrap">
      ...
      <div class="cc-stats">
        <div class="cc-stat-item">
          <div class="cc-stat-icon"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 10v6M2 10l10-5 10 5-10 5z"/><path d="M6 12v5c3 3 9 3 12 0v-5"/></svg></div>
          <div>
        ...
        <div class="cc-stat-item">
          <div class="cc-stat-icon"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="7"/><polyline points="8.21 13.89 7 23 12 20 17 23 15.79 13.88"/></svg></div>
          <div>
        ...
        ?>
          <div class="cc-card" data-lang="<?= $slug ?>">
            ...
            <div class="cc-card-right">
              <span class="cc-badge-complete"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:middle;margin-right:3px;"><polyline points="20 6 9 17 4 12"/></svg> Selesai</span>
      ...
      <div class="cc-empty" id="ccEmpty" style="display:<?= $has_completed ? 'none' : 'flex' ?>;">
        <div class="cc-empty-icon"><svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" style="color:var(--gray-soft);"><path d="M6 9H4.5a2.5 2.5 0 0 1 0-5C7 4 9 6 9 9v1a4 4 0 0 0 4 4h1"/><path d="M18 9h1.5a2.5 2.5 0 0 0 0-5C17 4 15 6 15 9v1a4 4 0 0 1-4 4h-1"/><path d="M5 18h14"/><path d="M10 14v4"/><path d="M14 14v4"/></svg></div>
