    ...
    <div class="page-card">
      ...
      <div class="video-list">
        ...
        <div class="video-item">
          ...
          <a href="<?= site_url('mentor/delete_video/' . $v['id']) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Hapus video ini?')"></a>
        </div>
        <?php endforeach; ?>
      </div>
      <?php endif; ?>
