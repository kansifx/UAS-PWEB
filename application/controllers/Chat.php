...
class Chat extends CI_Controller {
	...
	public function __construct()
	{
		...
		// Hanya user premium yang bisa akses
	...
	// API: Daftar percakapan mentor
	public function api_conversations()
	{
		$user_id = $this->session->userdata('user_id');

		// Cari mentor yang pernah chat
		...
		// Jika belum pernah chat, tampilkan semua mentor
		if (empty($mentors)) {
	...
	// API: Ambil pesan dengan mentor tertentu
	...
	// API: Hapus pesan (soft delete untuk diri sendiri)
